...
The TJUAV team competes in the annual [AUVSI SUAS ](https://www.auvsi-suas.org/)competition. AUVSI SUAS is an international, collegiate-level competition with many notable teams such as Harvard, Stanford, and Cornell competing. The rules for the AUVSI SUAS 2021 Competition can be found [here](https://static1.squarespace.com/static/5d554e14aaa5e300011a4844/t/600835a2dca4d066508885e8/1611150754642/auvsi_suas-2021-rules.pdf).

## **Tasks Overview**

While the tasks mostly stay the same, every couple of years a new challenge is added. This year, they introduced the map stitching task.
